...
#Chargement de notre liste de contacts apres les dernieres modifications
mesContacts = []
mesContacts = {}
with open('mesContacts.txt') as monFichier:
    mesContacts = json.load(monFichier)
    monFichier.close()
...
if __name__ == '__main__' :
    ...
    while continuer == False:
        ...
        if optionUtilisateur  in ["L", "l"]:
            ...
            print('\t\t Desosle! Cette option est invalide.')
